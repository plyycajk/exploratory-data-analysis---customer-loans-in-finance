...
class DataTransform:
    '''
    Docstring for class p[aceholder
    ...
    def str_to_datetime(self):
      ...
      print(f'converted {datetime_transformations} to datetime format')
      return self.df
    ...
    def to_category(self):
      ...
      print(f'converted {category_cols} to categorical dtype')
      return self.df
    ...
    def remove_text(self):
      ...
      cols_to_change = []
      for d in str_transformations:
        for k in d:
          cols_to_change.append(k)

      for i in range(len(str_transformations)):
        changes=(str_transformations[i][cols_to_change[i]])
